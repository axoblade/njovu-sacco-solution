...
<?PHP
	...
	if (isset($_POST['newloan'])){
		...
		$loan_appfee_receipt = time();//sanitize($db_link, $_POST['loan_appfee_receipt']);
			...
			<form method="post" onSubmit="return validate(this)">
				<table id ="tb_fields" style="width:85%;">
					...
					<tr>
						...
						<td>
							<input type="number" class="defaultnumber" name="loan_appfee_receipt" value="<?php echo time(); ?>" placeholder="for Loan Appl. Fee" disabled="true" />
						</td>
					</tr>
